  ...
  return (
    <div className="dark:bg-black">
      ...
      <div className=" text-center">
        <h2 className="md:text-3xl max-md:text-lg font-semibold text-gray-800 mb-3 dark:text-white">
          Ready to reach thousand of gamers?
        </h2>

        <div className="flex justify-center items-center gap-4 mb-6">
          <Link href="/publish-ad">
            <button className="bg-custom-gradient max-md:w-64 hover:bg-none hover:text-white hover:outline-dashed md:w-80 rounded-md max-md:text-sm md:text-base p-1  text-white">
