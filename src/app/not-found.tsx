          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <Link
                key={cat.name}
                href={cat.link}
                className="flex items-center justify-center rounded-full bg-secondaryColorLight px-4 py-6 text-white shadow-sm transition hover:opacity-90"
              >
                {cat.name}
              </Link>
            ))}
