...
const Rightsection = ({ data }: any) => {
  ...
  return (
    <div className=" max-md:hidden py-10 flex flex-col  justify-center items-start gap-y-8 pl-2">
      {/* First Card (Price & Quantity) */}
      <div className=" h-fit border-gray-300 rounded-lg p-6 w-[16rem] lg:w-[300px] bg-white shadow-md flex flex-col justify-between dark:bg-black">
        {/* Price Heading */}
...
*/}{" "}
      ...
      <div className="dark:bg-black border-gray-300 rounded-lg p-6 w-[16rem] lg:w-[300px] h-fit bg-white shadow-md flex flex-col items-center">
      ...
      <div className="dark:bg-black border-gray-300 rounded-lg p-6 w-[16rem] lg:w-[300px] h-64 bg-white shadow-md flex flex-col items-center">
        <Image
      ...
      <div className="dark:bg-black dark:text-white border-gray-300 justify-center rounded-lg p-4 w-[16rem]  lg:w-[300px] h-[40rem] relative bg-gray-200 shadow-md flex flex-col items-center">
