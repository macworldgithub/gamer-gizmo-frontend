...
//   return (
//     <div className="w-[25%] h-screen p-4 border border-black rounded-lg flex flex-col">
...
//         <SearchOutlined className="absolute left-3  text-gray-500 w-5 h-5" />
//         <input
//           type="text"
//           placeholder="Search"
//           className="w-full pl-10 pb-2 border-b border-gray-400 focus:outline-none text-black"
//         />
//       </div>
...
//                 <img src={chat.sellerImage} alt="Seller" className="w-6 h-6 rounded-full object-cover" />
