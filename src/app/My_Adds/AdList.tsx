      ...
      {ads.map((ad) => (
        ...
        >
          ...
          <div className="flex-1 px-0 lg:px-6">
            <h3 className="font-bold text-lg leading-6 break-words">{ad.title}</h3>
...
//   return (
//     <div>
//       <div className="flex justify-between items-center bg-black text-white w-fit px-4 rounded-full mb-4">
//         <span className="font-medium text-lg">All Ads ({ads.length})</span>
//       </div>

//       {ads.map((ad) => (
//         <div key={ad.id} className="flex items-center rounded-lg p-6 mb-6">
//           <img src={ad.image} alt={ad.title} className="w-28 h-28 rounded-lg object-cover" />
//           <div className="flex-1 px-6">
//             <h3 className="font-bold text-lg leading-6 break-words">{ad.title}</h3>
//             <div className="flex items-center text-gray-500 text-sm space-x-6 mt-2">
//               <span className="flex items-center gap-1">
//                 <IoEyeOutline size={20} /> Views ({ad.views})
//               </span>
//               <span className="flex items-center gap-1">
...
//                 <FaRegHeart size={20} /> Likes ({ad.likes})
//               </span>
//               <span className="pl-12 font-bold text-purple-600">
//                 AED <span className="text-2xl">{ad.price}</span>
//               </span>
//             </div>
//           </div>
...
//                 <button className="px-6 border border-black font-bold rounded-full hover:bg-gray-200">
//                   Edit
//                 </button>
//                 <button className="px-6 text-[#ff0000] border border-[#ff0000] font-bold rounded-full hover:bg-red-100">
//                   Delete
//                 </button>
//               </div>
//             </div>
