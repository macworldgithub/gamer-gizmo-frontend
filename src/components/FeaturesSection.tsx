        ...
        <section className="bg-white py-6 px-5 w-full mb-4 dark:bg-black">
          ...
          {title && (
            <div className="text-center mb-4">
              <h1 className="max-md:text-lg md:text-3xl font-bold dark:text-white">
                {title}
              </h1>
            </div>
          )}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                ...
                {/* Feature Title */}
                {feature.title && (
                  <h2 className="text-lg max-md:text-sm font-semibold mb-1 dark:text-white">
                    {feature.title}
                  </h2>
                )}
                {/* Feature Description */}
                <p className="text-gray-600 max-md:text-xs max-md:w-36 md:w-56 dark:text-white">
                  {feature.description}
                </p>
                {showButton && (
