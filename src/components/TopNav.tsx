...
const TopNav = () => {
  return (
    <div
      className={`max-md:w-full max-md:h-20 h-16 bg-gray-50 max-md:mx-auto  flex max-md:justify-center lg:justify-between md:justify-center items-center  md:px-0 lg:px-10`}
    >
      {/* Dropdown Menus */}
      ...
      <div className="flex max-sm:block justify-center items-center">
          ...
          <div className="px-4 tracking-wider max-sm:w-[5rem] sm:w-[5rem] md:w-44 max-sm:h-8 h-[2rem] md:h-12 ml-2 mr-8 py-1 flex justify-center items-center text-[0.6rem] md:text-lg bg-custom-gradient text-white rounded-md">
            05:29:32:48
          </div>
        </div>
