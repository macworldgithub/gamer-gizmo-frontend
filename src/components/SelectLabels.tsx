...
export default function SelectLabels() {
  ...
  return (
    ...
    //   </FormControl>
    // </div>
    <div className="flex max-md:flex-col bg-[#ffffff] justify-around max-md:rounded-md items-center md:w-[47rem] lg:w-[60rem] max-md:w-[20rem] max-md:h-[30rem] max-md:py-5 md:h-[5.625rem] px-4 mt-5 rounded-md gap-6">
