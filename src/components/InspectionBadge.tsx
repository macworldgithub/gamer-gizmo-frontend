  ...
  return (
    <div className="flex max-md:flex-col items-center p-3 w-[100%] bg-secondaryColorDark rounded-lg shadow-md">
      ...
      <div className="ml-3 flex-1 ">
        ...
        <p className="md:text-xs max-md:text-[0.5rem] md:w-80 lg:w-96  max-md:hidden max-md:w-75 max-md:pl-2 text-white">
      ...
      {/* Button Section */}
      <button
        className="bg-bluishBorder text-sm md:text-[0.7rem] lg:p-2 lg:text-base text-black font-bold p-1 rounded-lg hover:bg-secondaryColorLight"
