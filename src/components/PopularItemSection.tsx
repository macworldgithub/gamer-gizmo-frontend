  ...
  return (
    <div className="px-6 sm:px-6 md:px-10 lg:px-12">
      <div className="my-4">
        ...
        <Wrapper>
          <div className="flex gap-5 overflow-x-auto scrollbar-hide">
            {products.map((product) => (
              <div
                key={product.id}
                className="flex-none dark:bg-black dark:text-white shadow-md rounded-lg overflow-hidden border border-gray-200 w-[55%] max-sm:w-[70%] sm:w-[40%] md:w-[35%] lg:w-[18.5%]"
              >
                <div
        ...
        <div className="flex justify-end gap-6 mt-6 md:pr-16">
          <button
