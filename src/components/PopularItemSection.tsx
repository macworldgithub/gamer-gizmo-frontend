...
const PopularItemSection: React.FC<SectionProps> = ({
  ...
  return (
    ...
    //     {/* Product Section */}
    //     <div className="flex gap-4 lg:justify-between overflow-x-auto scrollbar-hide px-16">
    //       {products.map((product) => (
    //         <div
    //           key={product.id}
    //           className="flex-none dark:bg-black dark:text-white shadow-md rounded-lg overflow-hidden border border-gray-200 w-[55%] sm:w-[40%] md:w-[40%]  lg:w-[14.5%]"
    //         >
    //           {/* Image Section */}
    //           <div className="relative w-full h-[6rem] sm:h-[7rem] md:h-[8rem] lg:h-[6rem] my-1">
    //             <Image
