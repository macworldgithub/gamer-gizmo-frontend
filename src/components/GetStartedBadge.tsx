    ...
    <div>
      ...
      <div className="bg-bluishBorder p-4 rounded-lg pb-8 flex flex-row max-md:gap-1 md:gap-4  justify-center items-center px-5">
        <div className="flex items-center">
          ...
          <p className="text-purple-500 font-small md:text-sm max-md:text-[0.6rem] whitespace-nowrap">
            Got a verified badge yet?
          </p>
        </div>
        <p className="md:text-xs max-md:text-[0.6rem] text-black whitespace-nowrap ">
