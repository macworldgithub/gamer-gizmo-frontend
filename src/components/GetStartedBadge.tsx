...
const GetStartedBadge = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-bluishBorder p-4 rounded-lg pb-8 flex flex-row max-md:gap-2 md:gap-4 w-3/4 justify-center items-center px-8">
        <div className="flex items-center">
          ...
          <p className="text-purple-500 font-small md:text-lg max-md:text-[0.2rem]">
            Got a verified badge yet?
          </p>
        </div>
        <p className="md:text-sm max-md:text-[0.3rem] text-black ">
          Get more visibility and enhance your credibility.
        </p>
        {/* {!profileData.applied_for_verification ? ( */}
        <button
          onClick={() => setOpenNicModal(true)}
          className=" bg-purple-500 text-white max-md:px-1 max-md:text-[0.4rem] max-md:w-36 px-4 py-2 max-md:text-xs rounded-md md:text-sm hover:bg-purple-600"
        >
          Get Started
        </button>
        {/* ) : ( */}
